...
base_data_cfg = dict(
    type="BEATXDataseth3d",
    pose_rep="smplxflame_30",
    facial_rep="smplxflame_30",
    data_path="/Dataset/mas-liu.lianlian/beat_v2.0.0/beat_english_v2.0.0/",
    cache_path="/Dataset4D/public/mas-liu.lianlian/output/RAGesture/data/", # 
    debug=False,
    tiny=False,
    ...
    deps_path="/home/mas-liu.lianlian/SynTalker/datasets/hub/",
    training_speakers=[2],  # 训练人ID
